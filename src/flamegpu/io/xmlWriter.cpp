...
xmlWriter::xmlWriter(const std::string &model_name, const unsigned int &instance_id, const std::unordered_map<std::string, std::shared_ptr<AgentPopulation>> &model, const unsigned int &iterations, const std::string &output_file)
    : StateWriter(model_name, instance_id, model, iterations, output_file) {}
