...
class xmlReader : public StateReader {
 public:
     ...
     * @param instance_id Instance is from the Simulation instance to load the environment properties into
     ...
     */
    xmlReader(const std::string &model_name, const unsigned int &instance_id, const std::unordered_map<std::string, std::shared_ptr<AgentPopulation>> &model_state, const std::string &input_file);
    /**
